...
class AmplitudeChangePasswordJob extends AmplitudeJob
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->attributes['name'] = 'Изменить пароль';
        $this->attributes['check'] = 'job';
        $this->event_name = 'change_password';
    }
     ...
     * user_id
     *
     * передается при нажатии на кнопку "изменить пароль
     *
     * @return void
     */
