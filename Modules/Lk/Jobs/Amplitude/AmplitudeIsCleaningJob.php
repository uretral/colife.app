...
class AmplitudeIsCleaningJob extends AmplitudeJob
{
    ...
    public function __construct(array $attributes = [])
    {
        ...
        $this->attributes['name'] = 'Настройки - Уборка';
        $this->attributes['check'] = 'job';
        $this->event_name = 'is_cleaning';
    }
     ...
     *
     * передается при изменении положения тумблера Уборка
     *
     * @return void
     */
