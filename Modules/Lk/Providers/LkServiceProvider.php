...
use Modules\Lk\Exceptions\Handler;
...
class LkServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $moduleName = 'Lk';

    /**
     * @var string $moduleNameLower
     */
    protected string $moduleNameLower = 'lk';
...
//    public $user = null;
    ...
    public function boot(): void
    {
        ...
        Blade::componentNamespace('Modules\\Lk\\View\\Components', 'tenant');
    }
