 ...
 */
class ProcessPushPlanfixUnit implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    protected PlanfixToBitrixUnitItemData $dto;
     ...
     * @return void
     */
    public function __construct(PlanfixToBitrixUnitItemData $dto)
    {
        $this->dto = $dto;
    }
    ...
    public function handle()
    {
        try {
            ...
            Log::channel('bitrix')->info("Добавлена Комната: " . $bx_id);
            return true;
        } catch (\Exception $e) {
